	...
	<div class="container">
			...
			<div class="inner_w3l_agile_grids">
					<div class="col-md-3 team-grids">
						...
						<div class="col-md-3 team-grids">
						<div class="thumbnail team-w3agile">
							<img style="width: 405px; height: 285px" src="<?php echo base_url('assets/kopi.jpg')?>" class="img-responsive" alt="">
							<div class="social-icons team-icons right-w3l fotw33">
							<div class="caption">
								<h4>Anika Mollik</h4>
								<p>Add Short Description</p>						
						...
						<div class="col-md-3 team-grids">
						<div class="thumbnail team-w3agile">
							<img src="<?php echo base_url('assets/depan/images/t3.jpg')?>" class="img-responsive" alt="">
							<div class="social-icons team-icons right-w3l fotw33">
							<div class="caption">
								<h4>Megali Deo</h4>
								<p>Add Short Description</p>						
						...
						<div class="col-md-3 team-grids">
						<div class="thumbnail team-w3agile">
							<img src="<?php echo base_url('assets/depan/images/t4.jpg')?>" class="img-responsive" alt="">
							<div class="social-icons team-icons right-w3l fotw33">
							<div class="caption">
								<h4>Retas Word</h4>
								<p>Add Short Description</p>						
...
<!-- //team -->
	...
	<div class="schedule-bottom">
		<div class="col-md-6 agileinfo_schedule_bottom_left">
			<img src="<?php echo base_url('assets/depan/images/tt.jpg')?>" alt=" " class="img-responsive" />
		</div>
