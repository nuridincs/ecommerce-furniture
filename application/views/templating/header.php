...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/admin/css/sweetalert2.css')?>">
		...
		<script src="<?php echo base_url('assets/admin/js/sweetalert2.js')?>" type="text/javascript" charset="utf-8"></script>
		<style type="text/css">
			#notifikasi {
			    cursor: pointer;
			    position: fixed;
